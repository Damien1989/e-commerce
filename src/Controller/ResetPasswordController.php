...
class ResetPasswordController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        if ($request->get('email')) {
            ...
            if ($user) {
                //1 : Enregistrer en bdd la demande de reset_password avec user, token, created_at.
                ...
                // 2: Envoyer email à utilisateur avec un lien permettant de mettre à jour son mot de passe.
                ...
                $this->addFlash('notice', 'Vous allez recevoir dans quelques secondes un mail avec la procédure de réinitialiser votre mot de passe.');
            } else {
